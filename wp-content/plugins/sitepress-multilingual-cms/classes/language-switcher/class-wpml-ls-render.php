...
class WPML_LS_Render extends WPML_SP_User {
	...
	public function init_hooks() {
		...
		add_shortcode( 'wpml_language_selector_footer', array( $this, 'wpml_footer_language_selector_action' ) );
	...
	public function get_preview( $slot ) {
		...
		$ret['css']      = $this->current_template->get_styles();
		$ret['js']       = $this->current_template->get_scripts();
	...
	private function render_menu_preview( $slot ) {
		...
		$defaults = array( 'before' => '', 'after' => '', 'link_before' => '', 'link_after' => '' );
	...
	private function get_parsed_availability_text( $slot ) {
		...
		$html         = sprintf( $slot->get( 'availability_text' ), $this->render( $slot ) );
