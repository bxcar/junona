...
if (get_field('check_sidebar_display', current_page_lang())) { ?>
    ...
    <div class="sidebar">
        <div class="search">
            <form name="searchform" role="search" method="get" id="searchform" action="<?php echo home_url('/') ?>"
                ...
                <input type="text" value="<?php echo get_search_query() ?>" name="s" id="s"
                       placeholder="<?php the_field('placeholder_search', current_page_lang()) ?>">
        ...
        <div class="last-news">
            <div class="sidebar-title"><?php the_field('last_posts_title', current_page_lang()) ?></div>
            <?php
            $args_popular_news = array(
                'post_type' => 'news', //slag
                'posts_per_page' => get_field('last_posts_in_sidebar_amount', current_page_lang()),
            );
        ...
        <div class="archive wow fadeInUp" data-wow-duration="1s">
            <div class="sidebar-title"><?php the_field('archive_news_title', current_page_lang()) ?></div>
            <ul>
